<div class="admin-container">
    ...
    <div class="form-container">
        <form method="POST" action="<?= url('/admin/settings/update?id=' . $setting['id']) ?>">
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <small class="form-help">Setting key cannot be changed after creation.</small>
            </div>
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="description"
                    class="form-control"
                    value="<?= htmlspecialchars($setting['description'] ?? '') ?>"
